...
public class TransacaoTest {
	...
	public void addDescontoTest() {
		...
		t.addDesconto(Genero.COMEDIA, 0);
		assertEquals(null, t.descontoHmap.get(Genero.COMEDIA));
		t.addDesconto(Genero.DRAMA, 100);
		assertEquals(100, t.descontoHmap.get(Genero.DRAMA), 0);
		t.removeDesconto(Genero.DRAMA);
		t.addDesconto(Genero.DRAMA, 101);
		assertEquals(null, t.descontoHmap.get(Genero.DRAMA));
	}
	@Test
